...
This is a sample template for CircleCIDeploySample - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name circlecideploysample \
...
```bash
sam logs -n HelloWorldFunction --stack-name circlecideploysample --tail
```
...
```bash
aws cloudformation delete-stack --stack-name circlecideploysample
```
